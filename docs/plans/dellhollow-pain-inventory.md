...
| 7 | **quay-deck__pilot-cluster flight** [58–60.6, 9.8–13.9, −20.8..−17.3] | geometry (v1 stair) | 21 steps / 4 runs (weave cluster); down stalls [58.61, 13.67, −17.66], up stalls [59.34, 9.04, −20.83] | HALF FIXED 2026-08-06 (Bet 2 it.2+3, a3a1a67): redesigned v2 hairpin w2.0 + head apron — plaza<->pilot-cluster reached BOTH ways. FOOT still splits: l2 roofs the pilot->weave road in the body window; searched line owed (DAYLOG ~05:00). |
