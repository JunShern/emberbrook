...
| 4 | **shelf shop row pinches** [32–36.5, 19, −8.5..−6] | geometry (narrow pinch) | 34 steps / 5 runs + 17 steps; drive W→E stalls at [34.64, 19.07, −8.31] | RE-MEASURED 2026-08-06 (Bet 2 it.7, current bundle): the road drives CLEAN 2/2 BOTH ways — the recorded stall does not reproduce. Pinch itself real: `--who` names shelf_weapon_shop001_1/_2/_4 on 60 cells flanking the lane. Widen-vs-demote is a shelf_build design call, next window. |
