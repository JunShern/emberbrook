...
| images | 29 | 34 | - | - |
| materials | 17 | 19 | - | - |
| build s | 2.07 | 8.12 | 0.192 | 0.145 |

Where the build time goes: field 0.26s, zone grid 0.077s, terrain mesh 0.18s, planting 3.45s (143 trees).  The zone grid — the whole encounter geography of a 280 x 200u region, 224 x 160 cells — costs **0.077 s**.
