...
| verts | 116492 | 330402 | 10786 | 5900 |
| tris | 53952 | 168953 | 4996 | 3017 |
| GLB MB | 22.50 | 33.23 | 2.08 | 0.59 |
| embedded texture MB | 17.03 | 17.42 | - | - |
| images | 29 | 34 | - | - |
| materials | 17 | 19 | - | - |
| build s | 2.07 | 6.93 | 0.192 | 0.124 |

Where the build time goes: field 0.23s, zone grid 0.068s, terrain mesh 0.18s, planting 3.27s (143 trees).  The zone grid — the whole encounter geography of a 280 x 200u region, 224 x 160 cells — costs **0.068 s**.
...
Zone grid: 224 x 160 cells of 1.25u (35840 total), run-length encoded to 12.9 kB.
