...
| verts | 116492 | 641006 | 10786 | 11447 |
| tris | 53952 | 265006 | 4996 | 4732 |
| GLB MB | 22.50 | 45.52 | 2.08 | 0.81 |
| embedded texture MB | 17.03 | 17.42 | - | - |
| images | 29 | 34 | - | - |
| materials | 17 | 21 | - | - |
| build s | 2.07 | 11.11 | 0.192 | 0.198 |

Where the build time goes: field 0.25s, zone grid 0.070s, terrain mesh 0.17s, planting 3.40s (143 trees).  The zone grid — the whole encounter geography of a 280 x 200u region, 224 x 160 cells — costs **0.070 s**.
