  ...
  beats: [
    ...
    B('Arrival — the stair-street', 'stairs',
      ...
      [
        ...
        ex2.talkBlock('Window’s up the stair, loaf’s a penny.', 'Old Creel, while the loaf errand is open'),
        ex2.talkBlock('Mind your feet going down.', 'talking to Old Creel again (repeat)'),
        { context: 'giving Creel the loaf — the rope (giftLoaf)', lines: ex2.extractCutscene('giftLoaf') },
        ...
        { context: 'the eel-bought Mochi gap (playMochiGap, optional)', lines: ex2.extractCutscene('playMochiGap') },
      ]),
    ...
    B('The quay', 'dellhollow',
      ...
      [
        ...
        { context: 'the rope-gated ledge cache (playLedgeCache, optional)', lines: ex2.extractCutscene('playLedgeCache') },
        { context: 'giving Maren the boat-hook (giftBoatHook, optional)', lines: ex2.extractCutscene('giftBoatHook') },
