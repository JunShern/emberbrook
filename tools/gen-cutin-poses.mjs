...
/* art bottom = box top (72px up) minus the 55% sink (36px) = 36px — INSIDE the
   opaque box, never below it; the game's box meets the frame bottom so nothing
   can peek out under it, and this reproduces that. */
.stage img{position:absolute;left:50%;transform:translateX(-50%);bottom:36px;height:320px;width:auto;z-index:0}
