#!/usr/bin/env python3
"""festival REGISTRATION-MARK template (copy of blocks9_template.py).
...
Usage: python3 tools/festival_template.py OUT.png
"""
import sys
...
if __name__ == '__main__':
    main(sys.argv[1] if len(sys.argv) > 1 else 'festival-template.png')
