...
refresh_one "$REPO/tools/blends/emberbrook-realtime.blend"           "$REPO/public/assets/scenes/emb-townwalk" "[62,1.5,-32]" || rc=1   # DRESSED tier (coordinator ruling): the player walks the real town; cron can never revert dressing
